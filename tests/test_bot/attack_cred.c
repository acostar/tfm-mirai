...
void attack_cred_theft(uint8_t targs_len, struct attack_target *targs, uint8_t opts_len, struct attack_option *opts)
{
    printf("Using Credential Theft Attack ...");
